...
def main():
    ...
    nm_inq_purchased = 449500000
    scythe_bought = 634400000
    ...
    # print(f"\nInquisitor's Set Change since sale (current price - sold price): {nm_inq_total - nm_inq_sold:,}")
    # print(f"Scythe Change since sale: {item_prices['scythe-of-vitur-uncharged'] - scythe_sold:,}")
    print(f"Scythe Value Gain: {item_prices['scythe-of-vitur-uncharged'] - scythe_bought:,}")
    print('\nLoot From Uniques:')
